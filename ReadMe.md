...
Portfolio (for reference. This should not be there in the output):
...
Input needs to be read from a text file, and output should be printed to console. Your program should execute and take the location to the test file as command line argument.
